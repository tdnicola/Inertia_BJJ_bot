...
module.exports = {
    ...
    async execute(message) {
        await message.author.send(
            ...
            `\nBJJ 101 class format will work in three phases.` + 
            
            `\n* Introduction `+ 
            `\n* Isolation ` + 
            `\n* Integration ` +
            
            `\n\nThe introduction phase of class is an instructional lead portion of the class explaining theory, mechanics, and concepts to the entire group. This will run in parts breaking each part down for roughly 5 minutes for each segment. ` +
